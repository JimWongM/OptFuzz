...
public class Events {
    ...
    /// Signals that clear phase bitmap
    public let myPreExecute = Event<Program>()

    /// Signals that compute phase bitmap
    public let myPostExecute = Event<Program>()

    /// Signals that update statics
    public let myUpdateStatics = Event<[UInt32]>()
    ...
    public let AddBitmap_hit = Event<[UInt32]>()
    public let AddBitmap_total = Event<[UInt32]>()
