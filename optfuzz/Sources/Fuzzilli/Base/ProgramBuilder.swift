...
public class ProgramBuilder {
    ...
    // invoked by phase CodeGenMutator
    public func build1(n: Int = 1, by mode: BuildingMode = .runningGeneratorsAndSplicing, flag: Int) {
        assert(buildStack.isEmpty)
        //buildInternal(initialBuildingBudget: n, mode: mode)
        let initialBuildingBudget = n
        ...
        switch flag {
        case 1:
            availableGenerators = fuzzer.codeGenerators1.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 2:
            availableGenerators = fuzzer.codeGenerators2.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 3:
            availableGenerators = fuzzer.codeGenerators3.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 4:
            availableGenerators = fuzzer.codeGenerators4.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 5:
            availableGenerators = fuzzer.codeGenerators5.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 6:
            availableGenerators = fuzzer.codeGenerators6.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 7:
            availableGenerators = fuzzer.codeGenerators7.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 8:
            availableGenerators = fuzzer.codeGenerators8.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 9:
            availableGenerators = fuzzer.codeGenerators9.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 10:
            availableGenerators = fuzzer.codeGenerators10.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 11:
            availableGenerators = fuzzer.codeGenerators11.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 12:
            availableGenerators = fuzzer.codeGenerators12.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 13:
            availableGenerators = fuzzer.codeGenerators13.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 14:
            availableGenerators = fuzzer.codeGenerators14.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 15:
            availableGenerators = fuzzer.codeGenerators15.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 16:
            availableGenerators = fuzzer.codeGenerators16.filter({ $0.requiredContext.isSubset(of: origContext) })
        case 17:
            availableGenerators = fuzzer.codeGenerators17.filter({ $0.requiredContext.isSubset(of: origContext) })
        default:
